...
public class WarUpdater implements Updater {
    ...
    private static Map<String, String> getCopyFileMap(File tempFilePath) {
        ...
        copyFileMap.put(PathUtil.getRootPath() + AdminConstants.ATTACHED_FOLDER, tempFilePath.toString());
    ...
    @Override
    public String buildUpgradeFile(String upgradeFile, String upgradeKey) throws Exception {
