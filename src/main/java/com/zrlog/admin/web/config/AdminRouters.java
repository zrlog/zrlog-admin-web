...
public class AdminRouters {
    ...
    public static void configAdminRoute(Router router, AdminResource adminResource, String contextPath) {
        ...
        router.addMapper("/api" + AdminConstants.ADMIN_URI_BASE_PATH + "/system/health-check", AdminSystemController.class, "healthCheck");
        router.addMapper("/api" + AdminConstants.ADMIN_URI_BASE_PATH + "/system/optimize", AdminSystemController.class, "optimize");
