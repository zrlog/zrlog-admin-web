...
public final class AdminUserPages {
    private AdminUserPages() { }
    ...
    public static final Map<String, String> PAGE_APIS = Map.of(
            ...
            "/admin/user/members", "/api/admin/members",
            "/admin/user/permissions", "/api/admin/access");
    private static final Set<String> SENSITIVE_PAGES = Set.of(
            "/admin/user/applications", AUTHORIZE, "/admin/user/members", "/admin/user/permissions");
    ...
    public static String titleUri(String uri) {
        switch (uri) {
            ...
            case "/api/admin/members": return "/admin/user/members";
